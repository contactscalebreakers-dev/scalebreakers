...
- [ ] Check database for missing workshops (diorama build, character design, personalized tote bag)
- [ ] Restore missing workshops to display on website
- [ ] Lower all service prices by couple hundred dollars (3D Scanning, 3D Modelling, Murals)
- [ ] Identify and fix broken links on deployed site
- [ ] Prepare portfolio section for image uploads
- [ ] Prepare product section for image uploads
- [ ] Fix Stripe payment integration (mutate method issue)
- [ ] Deploy all fixes to Render
