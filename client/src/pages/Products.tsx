      ...
      <section className="bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600">
            Discover unique collectible figurines, urban dioramas, and original artwork. Each piece is carefully crafted with artistic vision and attention to detail.
          </p>
        </div>
      </section>
