      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl">
            Creating bold, vibrant art that breaks boundaries and inspires communities across Adelaide.
          </p>
        </div>
      </section>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
                <h4 className="text-lg font-bold mb-2">Adelaide CBD Street Art Series</h4>
                <p className="text-gray-600">
                  Large-scale murals featuring local culture, community themes, and urban aesthetics across Adelaide's central business district.
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
