        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
              Urban art & mural commissions. Collectible 3D art & figurines. Creative workshops for all ages and abilities in Adelaide.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link href="/about">
                    <span className="text-blue-600 hover:underline font-semibold">Adelaide CBD Street Art Series</span>
                  </Link>
