        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/products"><span className="hover:text-white transition">Products</span></Link></li>
              <li><Link href="/hire-me"><span className="hover:text-white transition">Hire Me</span></Link></li>
              <li><Link href="/about"><span className="hover:text-white transition">About</span></Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4">Services</h4>
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link href="/hire-me"><span className="hover:text-white transition">Mural Commissions</span></Link></li>
              <li><Link href="/hire-me"><span className="hover:text-white transition">3D Services</span></Link></li>
              <li><Link href="/workshops"><span className="hover:text-white transition">NDIS Programs</span></Link></li>
            </ul>
          </div>
          <div>
